...
export default function CadastrarAulas(): React.JSX.Element {
    ...
    const handleSubmit = async (
        ...
        const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/lesson/schedule-with-recurrence`, {
            method: "POST",
            headers: {
    ...
    return (
        <div className="container-principal">
            ...
            <h1 className="page-title">Formulário para Cadastro das Aulas usando Recorrência</h1>
